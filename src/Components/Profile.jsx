    ...
    <div className="flex items-center justify-center min-h-screen bg-gray-50">
      <div className="w-full max-w-lg bg-white rounded-xl shadow-sm overflow-hidden">
        ...
        <div className="pt-20 px-6 pb-8 text-center">
          ...
          {/* Action Button */}
          <button className="flex items-center justify-center w-full py-3 px-4 border border-gray-200 rounded-lg text-indigo-600 font-medium hover:bg-indigo-50 transition-colors">
